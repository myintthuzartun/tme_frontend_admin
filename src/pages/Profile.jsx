...
export const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://127.0.0.1:8000/api/admin-profiles')
      .then(response => {
        // Check if profiles exist and use the first one
  ...
  return (
    ...
    style={{
        ...
        maxWidth: "100%",  // Allows the image to scale to its container's width
        maxHeight: "300px", // Adjust to your desired max height
